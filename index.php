...
<head>
  ...
  <link rel="icon" href="assets/img/logokecil.png" src="assets/img/logokecil.png">
  ...
  <link href='https://fonts.googleapis.com/css?family=Droid+Serif:400,7 00,400italic,700italic' rel='stylesheet' type='text/css'>
  ...
  <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
    <div class="container">
      <a id="nav-logo" class="navbar-brand js-scroll-trigger float-left" href="#page-top">
        <!-- <?= $info_toko['nama_toko'] ?> -->
        <img src="assets/img/mainlogo.png" alt="<?= $info_toko['nama_toko'] ?>" class="w-50">
      </a>
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav text-uppercase ml-auto">
          ...
          <li class="nav-item">
           ...
           <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="#order">Pesan</a>
          </li>
          <li class="nav-item">
  ...
  <header class="masthead">
    <div class="container">
      <div class="intro-text">
        <div class="intro-lead-in">Maaci Laundry</div>
      ...
      <div class="row text-center">
        <div class="col-md-4">
          <span class="fa-stack fa-4x">
            ...
            <a class="tombol" href="member/"> <i class="fas fa-mobile-alt fa-stack-1x fa-inverse"></i></a>
          </span>
...
<!-- order -->
  <section class="page-section" id="order">
    <div class="container">
      <div class="row">
        <div class="col-lg-12 text-center">
           <h2 class="section-heading text-uppercase">Daftar & Cuci Sekarang</h2>
      ...
      <div class="row text-center">
        <div class="col-lg-12">
          ...
          <p class="text-muted">.</p>
          <h3 class="text-muted">Klik tombol Pesan Sekarang untuk memroses ke halaman pemesanan.</h3>
          <p class="text-muted">.</p>
          <a class="btn btn-primary btn-xl text-uppercase js-scroll-trigger" href="member/">Daftar</a>
        </div> 
      </div>
  ...
  <script>
    $(document).ready(function() {
      ...
      if ($('#mainNav').hasClass('navbar-shrink')) {
        navLogo.attr('src', 'assets/img/logoblack.png');
      } else {
        navLogo.attr('src', 'assets/img/mainlogo.png');
      }

      $(window).scroll(function() {
        let navLogo = $('#nav-logo img');
        if ($('#mainNav').hasClass('navbar-shrink')) {
          navLogo.attr('src', 'assets/img/loginlogo.png');
        } else {
          navLogo.attr('src', 'assets/img/mainlogo.png');
        }
      });

        ...
        <div class="row">
            <div class="col-sm-12 col-md-8 col-lg-4 mx-auto">
                    ...
                    <div class="card-body">
                        ...
                        <form action="sistem/act_login.php" method="post">
                            <div class="form-group">
                                ...
                                <input type="text" name="id" id="id" class="form-control" placeholder="username" autofocus="" autocomplete="username" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-sm-12 col-md-3 ml-aut right">
                ...
                <div class="text-center mt-5">
                    <a href="../"><i class="fa fa-angle-double-left"></i> Kembali Ke Homepage</a>
                </div>
            </div>
        </div>
    </div>
